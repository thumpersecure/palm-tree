...
Network traffic tools for privacy testing and packet simulation.

## Tools Available

### 1. Traffic Noise Generator
...
**Traffic Noise Generator (Python version):**
- Python 3.8+
- httpx, beautifulsoup4, lxml, rich (see requirements.txt)

**Traffic Noise Generator (Bash version):**
- curl (required)
...
A lightweight Python tool for generating random network packets with various protocols.
...
No external dependencies required. Just use the scripts:
